...
public class DropHeadEvent 
{
	...
	public DropHeadEvent(DropHeadSystem dropHeadSystem)
	{
		  
		  //_bukkitUtility = BukkitUtility.Instance();	
		  
		  _dropHeadConfig = new DropHeadConfig();
		  _dropHeadSystem = dropHeadSystem;
	}
	  ...
	  public void onBlockBreakEvent(BlockBreakEvent evt)
	  {
	    ...
	    GameProfile profile = getGameProfile(skull);
	    if (profile != null)
	    {
	      evt.setCancelled(true);
	      evt.getBlock().setType(Material.AIR);
	      evt.getBlock().getWorld().dropItemNaturally(skull.getLocation(), _dropHeadSystem.getHead(profile));
	    }
	  }
	  */
	  ...
	  public void entityDeathEvent(EntityDeathEvent evt)
	  {
	    ...
	    {
	      victim.getWorld().dropItem(victim.getLocation(),_dropHeadSystem.getHead(victim));
...
/*
		  public void onBarf(ItemSpawnEvent evt)
		  {
		    ...
		    GameProfile profile = getGameProfile(meta);
		    if (profile != null)
		    {
		      ItemStack refreshedItem = _dropHeadSystem.getHead(profile);
		      if (name != null)
		      {
