...
public class SignEditSystem extends BaseSystem  implements ISystem
{
	...
	{
		super(Module.SignEditSystem, SystemState.Active, SystemPriority.Low);
		_instance = this;
	...
	private String ConvertTagToText(String line)
	{
		...
		{
			line = _config.SignEdit.LineTag.Text;
		}
		else if(line.contains(_config.SignEdit.TeleportTag.Tag))
		{
			line = _config.SignEdit.TeleportTag.Text;
		}	
	...
	{
		if(line.contains(_config.SignEdit.LineTag.Text))
		{
			line = _config.SignEdit.LineTag.Tag;
		}
		else if(line.contains(_config.SignEdit.TeleportTag.Text))
		{
