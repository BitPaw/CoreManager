...
public class CommandUpdate implements ICommand
{
    ...
    public String reactBadArgsSize(final String usedCmd) {
        return ChatColor.DARK_RED + DigitalClockSystem.getMessagePrefix() + ChatColor.RED + " Correct usage: '/" + usedCmd + " update'";
    }
    ...
    public void process(final DigitalClockSystem main, final Player player, final String[] args) {
        //Version.update((CommandSender)player, DigitalClockSystem.getMessagePrefix(), main.getDescription().getVersion(), main.getDescription().getName());
    }
}
