...
/*     */   {
/*  79 */     return ((Byte)this.handle.getBytes().read(0)).byteValue();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/*  87 */     this.handle.getBytes().write(0, Byte.valueOf(value));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 111 */     return ((Byte)this.handle.getBytes().read(1)).byteValue();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 119 */     this.handle.getBytes().write(1, Byte.valueOf(value));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 127 */     return ((Short)this.handle.getShorts().read(0)).shortValue();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 135 */     this.handle.getShorts().write(0, Short.valueOf(value));
/*     */   }
/*     */ }


/* Location:              B:\(SSC)\[Java]\_Decompiled\ClickEdit.jar!\com\bobacadodl\ClickEdit\packetwrapper\WrapperPlayServerEntityEffect.class
