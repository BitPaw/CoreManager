...
/*     */ {
/*  32 */   public static final PacketType TYPE = PacketType.Play.Server.NAMED_SOUND_EFFECT;
/*     */   
...
/*     */         
/*     */ 
/* 221 */         for (Field field : NamedSoundEffects.class.getFields()) {
/*     */           try {
/* 223 */             result.add((String)field.get(null));
/*     */           } catch (Exception e) {
/* 225 */             throw new RuntimeException("Cannot read field.", e);
/*     */           }
/*     */         }
/*     */         
/* 229 */         values = (String[])result.toArray(new String[0]);
/*     */       }
/* 231 */       return values;
/*     */     }
/*     */   }
...
/*     */   {
/* 241 */     return (String)this.handle.getStrings().read(0);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 250 */     this.handle.getStrings().write(0, value);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 259 */     return getEffectPosition(event.getPlayer().getWorld());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 268 */     return new Location(world, getEffectPositionX(), getEffectPositionY(), getEffectPositionZ());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 276 */     return ((Integer)this.handle.getIntegers().read(0)).intValue() / 8.0D;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 286 */     this.handle.getIntegers().write(0, Integer.valueOf((int)(value * 8.0D)));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 296 */     return ((Integer)this.handle.getIntegers().read(1)).intValue() / 8.0D;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 306 */     this.handle.getIntegers().write(1, Integer.valueOf((int)(value * 8.0D)));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 316 */     return ((Integer)this.handle.getIntegers().read(2)).intValue() / 8.0D;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 326 */     this.handle.getIntegers().write(2, Integer.valueOf((int)(value * 8.0D)));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 336 */     return ((Float)this.handle.getFloat().read(0)).floatValue();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 346 */     this.handle.getFloat().write(0, Float.valueOf(value));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 356 */     return ((Integer)this.handle.getIntegers().read(3)).intValue() / 63.0F;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 366 */     this.handle.getIntegers().write(3, Integer.valueOf((int)(value * 63.0F)));
/*     */   }
/*     */ }


/* Location:              B:\(SSC)\[Java]\_Decompiled\ClickEdit.jar!\com\bobacadodl\ClickEdit\packetwrapper\WrapperPlayServerNamedSoundEffect.class
