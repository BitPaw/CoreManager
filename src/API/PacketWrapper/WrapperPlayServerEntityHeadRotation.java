...
/*    */ {
/* 28 */   public static final PacketType TYPE = PacketType.Play.Server.ENTITY_HEAD_ROTATION;
/*    */   
...
/*    */   {
/* 78 */     return ((Byte)this.handle.getBytes().read(0)).byteValue() * 360.0F / 256.0F;
/*    */   }
/*    */   
/*    */ 
/*    */ 
...
/*    */   {
/* 86 */     this.handle.getBytes().write(0, Byte.valueOf((byte)(int)(value * 256.0F / 360.0F)));
/*    */   }
/*    */ }


/* Location:              B:\(SSC)\[Java]\_Decompiled\ClickEdit.jar!\com\bobacadodl\ClickEdit\packetwrapper\WrapperPlayServerEntityHeadRotation.class
